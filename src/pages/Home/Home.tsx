...
export function Home(): React.ReactElement {
    ...
    return (
        // <VStack >
        <HStack w="95%" p={4} spacing={0}>
            <Flex flexDirection="column" w="55%" padding={4}>
                <Heading fontSize="52px" mb={4}>Buy and Sell BitClout for Ethereum</Heading>
                <Heading fontSize="18px" color="#696F79" fontWeight="medium" lineHeight="8">BitSwap is the easiest and fastest way to buy and sell BitClout. Join the world&apos;s first BitClout exchange and start trading today!</Heading>

                <Box boxShadow="2xl" borderRadius="lg" overflow="hidden" bg="white" p="2" mt="4" borderWidth="2px" borderColor="#DDE2E5">
                    <HStack justify="space-evenly" >

                        <Text><Image src={globalVars.BITCLOUT_LOGO} htmlWidth="32" style={{display: "inline"}} /> {user ? +user.balance.bitclout.toFixed(2) : "-"} CLOUT</Text>
                        <Text><Image src={globalVars.ETHER_LOGO} htmlWidth="30" style={{display: "inline"}} /> {user ? +user.balance.ether.toFixed(2) : "-"} ETHER</Text>

                    </HStack>
                </Box>
                <Box boxShadow="2xl" borderRadius="lg" overflow="hidden" bg="white" p="2" mt="4" borderWidth="2px" borderColor="#DDE2E5">
                    <HStack w="full" justify="space-evenly" mt="2">
                        <Flex
                            // bgColor="#dbe6ff"
                            p="4"
                            color="brand.100"
                            ...
                            justify="center"
                            borderRadius="4"
                            borderWidth="2px" borderColor="#DDE2E5"
                        >
            ...
            <Spacer />
            <Flex flexDirection="column" w="45%" padding={4} justify="">
