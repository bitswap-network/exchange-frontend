...
const ChakraDemo: React.FC<{}> = (props) => {
      ...
      <Center>
        <VStack spacing={4} px={8}>
          ...
          <Text fontSize="sm" color="gray.700" noOfLines={[1, 2, 3]}>
            The world's first Bitclout exchange with automatic transaction
            verification. We've already facilitated $1.5m+ in private
            transactions — now, anybody can publicly buy, sell, and trade
            Bitclout in a matter of seconds.
          </Text>
